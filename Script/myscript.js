...
function showHideBack(id , class2 , class3 , class10 , class20 , class100 , class200) {
	...
	document.querySelector(class3).style.height="340px";
	document.querySelector(class3).style.border="2px solid hsl(176, 50%, 47%)";
	document.querySelector(".backProject").style.height="1400px";
	
	// other is hidden when clicked
	document.querySelector(class10).style.height="200px";
	document.querySelector(class20).style.height="200px";
